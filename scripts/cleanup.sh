...
# workloads in it) and the three custom demo policies. Safe to run multiple
# times.
#
...
python3 scripts/acs_api.py delete-policy "EAP-Init-Test: Missing Liveness Probe (main only)"
